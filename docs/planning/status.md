...
**State:** Experimental 0.1.0 source published to GitHub; initial hosted CI passed; tag, release candidate and deployment remain pending.
**Active item:** First public source publication and GitHub Pages release of the accepted [living MVP](../product/specifications/0001-mvp.md).
**Next action:** With the maintainer's explicit authorization, create and verify the annotated `v0.1.0` tag, then run the release-candidate workflow.
...
- Publication boundary: sanitized source through `b97d7a8` is public and its initial GitHub Actions verification passed; the tag, release workflows and Pages deployment remain intentionally unperformed.
...
- Hosted evidence: [Verify run 35105737402](https://github.com/chrwittm/egg-cooker/actions/runs/35105737402) completed successfully in 2m16s for `b97d7a8`; its Vitest summary reported 92 passing tests.
...
- Release follow-through: create and verify `v0.1.0`, run the release-candidate workflow, deploy Pages and smoke-test the hosted origin.
